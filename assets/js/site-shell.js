(function(){
  ...
  function surfacePresale(){
    ...
    section.innerHTML=''
      ...
      + '<h2 style="margin:0 0 10px;color:#fff;font-size:clamp(1.55rem,4vw,2.35rem)">Official RANNTA Token Sale on TON Is Open</h2>'
      + '<p style="max-width:900px;margin:0 auto 15px;color:#e9edf3;line-height:1.72">Purchase the existing official RANNTA Jetton on The Open Network (TON) through the dedicated presale contract. This sale is for the TON-based RANNTA token and is separate from RANNTA X-Chain and its native asset RNTX.</p>'
      + '<div style="display:flex;justify-content:center;gap:8px 16px;flex-wrap:wrap;margin:0 0 18px;color:#cfd5de;font-size:.9rem"><span>TON Jetton</span><span>•</span><span>Existing active liquidity</span><span>•</span><span>On-chain delivery</span><span>•</span><span>Separate from RANNTA X-Chain</span></div>'
